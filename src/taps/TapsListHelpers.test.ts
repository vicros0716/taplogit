    ...
    it.each<{ coalescedBy: ManipulateType; expected: { [key: string]: Tap[] } }>([
        {
            coalescedBy: 'day',
            expected: {
                '2024-05-26T07:00:00.000Z': [taps[0], taps[1]],
                '2024-05-27T07:00:00.000Z': [taps[2]],
                '2024-05-29T07:00:00.000Z': [taps[3], taps[4], taps[5]],
                '2024-05-31T07:00:00.000Z': [taps[6]],
                '2024-06-02T07:00:00.000Z': [taps[7]],
                '2024-06-03T07:00:00.000Z': [taps[8], taps[9]],
                '2024-06-06T07:00:00.000Z': [taps[10], taps[11], taps[12]],
            },
        },
        {
            coalescedBy: 'week',
            expected: {
                '2024-05-26T07:00:00.000Z': taps.slice(0, 7),
                '2024-06-02T07:00:00.000Z': taps.slice(7),
            },
        },
        {
            coalescedBy: 'month',
            expected: {
                '2024-05-01T07:00:00.000Z': taps.slice(0, 7),
                '2024-06-01T07:00:00.000Z': taps.slice(7),
            },
        },
